...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="${ctx}/file/downloadFile?type=head&filePath=${user.imgpath}" class="layui-nav-img userAvatar" width="35"
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像"><img src="${ctx}/file/downloadFile?type=head&filePath=${user.imgpath}" class="userAvatar"></a>
