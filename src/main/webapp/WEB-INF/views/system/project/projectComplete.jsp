...
<form class="layui-form" id="roleFrm">
    ...
    <input type="hidden" value="${id}" id="theid">

    <div class="layui-form-item">
        <label class="layui-form-label">备注</label>
        <div class="layui-input-block">
            <textarea type="text" name="complete" id="complete" placeholder="项目备注" autocomplete="off"
...
<script type="text/javascript">
    layui.use(['form', 'layer', 'jquery', 'upload'], function () {
            ...
            compute = function () {
                ...
                var data = 'id=' + $('#theid').val() + '&complete=' + $('#complete').val() + '&projectFileArray=' + projectFileArray;

                //data = JSON.stringify(data);
                // data = data + "&projectFileArray=" + projectFileArray;
                console.log(data);
                $.post(
                    '${ctx}/project/completeProject.json',
                    data,
                    function (data) {
                        if (data.code == 0) {
                            //弹出成功的提示
